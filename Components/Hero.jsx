      ...
      <div className="flex max-w-6xl mx-auto py-32 px-10 items-center p-5 justify-center  bg-white rounded-xl shadow-xl mt-16 mb-16">
        <div className="flex items-center mx-auto">
          <div className=" text-center">
            ...
            <button className="mt-10 mb-10  hover:bg-[#eed9c4] hover:text-white dark:hover:text-white dark:hover:bg-transparent border-[#eed9c4] border-2 hover:border-[#e4d5b7] transition-all duration-300 text-[#d9b99b] py-5 px-10 rounded-full text-lg font-bold tracking-wide">
              Save The Date
            </button>
          </div>
        </div>
